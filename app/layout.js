export const metadata = {
  ...
  alternates: {
    canonical: "https://www.theclubboils.com/",
  },
  openGraph: {
    title: "The Club Boils | Seafood Boils in Trinidad",
    description: "Order premium seafood boils, ramen and wings from The Club Boils in Arima, Trinidad. Open Thursday, Friday and Saturday for pickup and delivery.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "The Club Boils — Premium Seafood Boils in Trinidad",
      },
    ],
    locale: "en_TT",
    type: "website",
  ...
  twitter: {
    ...
    title: "The Club Boils | Seafood Boils in Trinidad",
    description: "Order premium seafood boils, ramen and wings from The Club Boils in Arima, Trinidad. Open Thursday, Friday and Saturday.",
    images: ["/spread2.jpeg"],
  },
  robots: {
    index: true,
  ...
  themeColor: "#C4952A",
  keywords: ["seafood boil", "Trinidad", "Arima", "shrimp", "crab", "ramen", "wings", "delivery", "pickup", "Club Boils"],
};
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        {/* Viewport — pinch-to-zoom allowed per accessibility brief */}
